...
- Install and download URLs point at the `v1.4.0` tag. Repository, homepage, and documentation URLs stay on `dango85/spec-kit-worktree-parallel`, which publishes this extension
